...
const worden = ['appel', 'banaan', 'aardbei', 'peer', 'ananas', 'bosbes'];

console.log('Alle getallen:', getallen);
console.log('Alle worden:', worden);
...
const langeAwoorden = worden.filter(woord => woord.startsWith('a') && woord.length > 5);
console.log('Lange woorden met a:', langeAwoorden);

//TODO: Filter even getallen die groter zijn dan 5 letters
const groteEvenGetallen = getallen.filter(getal => getal % 2 === 0 && getal > 5);
